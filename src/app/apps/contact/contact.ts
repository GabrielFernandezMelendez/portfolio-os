...
export class ContactComponent implements AfterViewInit {
  ...
  history = signal<TerminalLine[]>([
    ...
    { text: '(c) Gabriel Fernandez Corp. 2026. Todos los derechos reservados... o casi.',  type: 'system'  },
    { text: '',                                                                             type: 'system'  },
    ...
    { text: '',                                                                             type: 'system'  },
    { text: '─────────────────────────────────────────────────────',                       type: 'system'  },
    { text: 'Escribe un comando para contactar. Escribe "help" para ver los disponibles.', type: 'system'  },
    { text: '─────────────────────────────────────────────────────',                       type: 'system'  },
    { text: '',                                                                             type: 'system'  },
  ]);
  ...
  executeCommand() {
    ...
    switch (cmd) {
      ...
      case 'tlf':
        ...
        this.addLine('Por favor, saca el telefono, desbloquéalo, abre la app de llamadas...', 'warning');
        this.addLine('Numero: +34 648446865. Ya sabes como va esto.', 'warning');
        break;

      case 'help':
        this.addLine('Comandos disponibles:', 'system');
        this.addLine('  gmail    -> Abrir Gmail con mi direccion lista para recibir tu mensaje', 'info');
      ...
      default:
        ...
        this.addLine('Asi no podras contratarme. Escribe "help" para ver los comandos disponibles.', 'error');
        break;
    }
